      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center justify-start">
          ...
          <Link href="https://flowbite.com" className="flex ml-2 md:mr-24">
            <Image width={200} height={200} src="/profile-picture-5.jpg" className="h-8 mr-3" alt="FlowBite Logo" />
            ...
            <div className="flex items-center ml-3">
              <div>
                <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                  ...
                  <Image width={300} height={300} className="w-8 h-8 rounded-full" src="/profile-picture-5.jpg" alt="user photo"/>
                </button>
              </div>
